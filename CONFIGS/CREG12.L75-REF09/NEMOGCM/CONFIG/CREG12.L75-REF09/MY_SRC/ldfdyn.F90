...
902   IF( ios >  0 )   CALL ctl_nam ( ios , 'namdyn_ldf in configuration namelist' )
   ...
   SUBROUTINE ldf_dyn( kt, Kbb )
      ...
      CASE(  31  )       !==  time varying 3D field  ==!   = F( local velocity )
         ...
         ENDIF
!CT start
         IF( MOD( kt, 10000 ) == 0 .AND. lwp ) THEN
                  WRITE(numout,*) '          Increase by 20pc close to the Arctic singularity the Dyn bilap coef over few points with value '
                  WRITE(numout,*) '                    BEFORE the increase:' , ahmt( mi0(186):mi1(190) , mj0(1210):mj1(1215) , 1 )
         ENDIF

         ahmt( mi0(135):mi1(210) , mj0(1205):mj1(1335) , : ) = ahmt( mi0(135):mi1(210) , mj0(1205):mj1(1335) , : ) * 1.2
         ahmf( mi0(135):mi1(210) , mj0(1205):mj1(1335) , : ) = ahmf( mi0(135):mi1(210) , mj0(1205):mj1(1335) , : ) * 1.2

         IF( MOD( kt, 10000 ) == 0 .AND. lwp ) THEN
                 WRITE(numout,*) '                    AFTER  the increase:' , ahmt( mi0(186):mi1(190) , mj0(1210):mj1(1215) , 1 )
         ENDIF
!CT end 
         !
