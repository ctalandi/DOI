...
!CT DEBUG {
         ...
         IF(sn_cfctl%l_prtctl) THEN
            CALL prt_ctl(tab2d_1=ebot_iwm    , clinfo1=' zdf_iwm: ebot_iwm : ' )
            CALL prt_ctl(tab2d_1=ecri_iwm    , clinfo1=' zdf_iwm: ecri_iwm : ' )
            CALL prt_ctl(tab2d_1=ensq_iwm    , clinfo1=' zdf_iwm: ensq_iwm : ' )
            CALL prt_ctl(tab2d_1=esho_iwm    , clinfo1=' zdf_iwm: esho_iwm : ' )
            CALL prt_ctl(tab2d_1=hbot_iwm    , clinfo1=' zdf_iwm: hbot_iwm : ' )
            CALL prt_ctl(tab2d_1=hcri_iwm    , clinfo1=' zdf_iwm: hcri_iwm : ' )
         END IF
!CT DEBUG }
